...
resource "aws_security_group_rule" "vpn_ingress_client_tcp" {
  type                     = "ingress"
  description              = "Ingress port used for clients to connect with the VPN."
  from_port                = var.wireguard_client_port
  to_port                  = var.wireguard_client_port
  protocol                 = "tcp"
  cidr_blocks              = ["0.0.0.0/0"]
  security_group_id        = aws_security_group.wireguard_vpn.id
}

resource "aws_security_group_rule" "vpn_ingress_client_udp" {
  type                     = "ingress"
  description              = "Ingress port used for clients to connect with the VPN."
  from_port                = var.wireguard_client_port
  to_port                  = var.wireguard_client_port
...
# resource "aws_security_group_rule" "vpn_egress_tcp" {
#   type                     = "egress"
#   description              = "Egress port used for clients to connect with the VPN."
#   from_port                = var.wireguard_traffic_port
#   to_port                  = var.wireguard_traffic_port
#   protocol                 = "tcp"
#   cidr_blocks              = ["0.0.0.0/0"]
...
# resource "aws_security_group_rule" "vpn_egress_udp" {
#   type                     = "egress"
#   description              = "Egress port used for clients to connect with the VPN."
#   from_port                = var.wireguard_traffic_port
#   to_port                  = var.wireguard_traffic_port
